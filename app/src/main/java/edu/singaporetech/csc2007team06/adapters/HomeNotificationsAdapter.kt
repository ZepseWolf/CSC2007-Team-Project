...
import edu.singaporetech.csc2007team06.databinding.ItemHomeNotificationBinding
import edu.singaporetech.csc2007team06.models.Notification
import edu.singaporetech.csc2007team06.utils.Constant
import java.text.SimpleDateFormat
import java.util.*

class HomeNotificationsAdapter(val context: Context, var items: List<Notification>) :
    RecyclerView.Adapter<HomeNotificationsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Set notification title based on category
        when (item.category!!) {
        ...
        // Set notification check button based on acknowledge status
        ...
        // Set notification check button click listener
    ...
    inner class ViewHolder(binding: ItemHomeNotificationBinding) :
        RecyclerView.ViewHolder(binding.root) {
        val title = binding.tvNotificationTitle
        val button = binding.btnNotificationChecked
    }
}